 ...
 */
public interface PredicateWithExceptions4<T, E1 extends Throwable, E2 extends Throwable, E3 extends Throwable, E4 extends Throwable> {
	 ...
	 */
	boolean test(T t) throws E1, E2, E3, E4;
}