 ...
 */
public interface SupplierWithExceptions6<T, E1 extends Throwable, E2 extends Throwable, E3 extends Throwable, E4 extends Throwable, E5 extends Throwable, E6 extends Throwable> {
	/**
	 * Supplies a value.
	 *
	 ...
	 * @throws E5 a fifth type of exceptions thrown by the supplier
	 * @throws E6 a sixth type of exceptions thrown by the supplier
	 */
	T get() throws E1, E2, E3, E4, E5, E6;
}